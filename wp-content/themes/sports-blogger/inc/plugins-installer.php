...
function sports_blogger_admin_enqueue_scripts(){
    wp_enqueue_style( 'sports-blogger-admin-css', get_template_directory_uri() . '/assets/css/admin.css', false );

	wp_enqueue_script( 'sports-blogger-admin-script', get_theme_file_uri('/js/admin.js'), array( 'jquery' ), '', true );
    wp_localize_script( 'sports-blogger-admin-script', 'sports_blogger_ajax_object',
        array( 'ajax_url' => admin_url( 'admin-ajax.php' ) )
    );
}
add_action( 'admin_enqueue_scripts', 'sports_blogger_admin_enqueue_scripts' );

add_action( 'wp_ajax_install_act_plugin', 'sports_blogger_admin_install_plugin' );

function sports_blogger_admin_install_plugin() {
