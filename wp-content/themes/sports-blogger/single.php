...
<div id="primary" class="content-area">
	<main id="main" class="site-main">
		<?php do_action('sports_blogger_before_default_page'); ?>
			<div class="post-details-page">
						...
						<div class="previous-post">
							...
							<div class="postarrow">
								<a href="<?php echo get_permalink($prev_post->ID); ?>">
									<i class="fa fa-long-arrow-left"></i><?php echo esc_html_e( 'Previous Post', 'sports-blogger' ); ?>
								</a>
							</div>
					...
					<div class="next-post">
						...
						<div class="postarrow">
							<a href="<?php echo get_permalink($next_post->ID); ?>">
								<?php echo esc_html_e( 'Next Post', 'sports-blogger' ); ?><i class="fa fa-long-arrow-right"></i>
							</a>
						</div>
				...
				if (true === $s_post_el_is_on['show_recommend_posts']) :
					echo '<div class="related-post-wrapper">';
						sports_blogger_cats_related_post();
					echo '</div>';
				endif;
		...
		<?php do_action('sports_blogger_after_default_page'); ?>
	</main><!-- #main -->
</div><!-- #primary -->
<?php
get_footer();
